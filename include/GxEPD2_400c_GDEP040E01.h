...
#ifndef _GxEPD2_400c_GDEP040E01_H_
#define _GxEPD2_400c_GDEP040E01_H_

#include "GxEPD2_EPD.h"

class GxEPD2_400c_GDEP040E01 : public GxEPD2_EPD {
 public:
  // attributes
  static const uint16_t WIDTH = 400;
  static const uint16_t WIDTH_VISIBLE = WIDTH;
  static const uint16_t HEIGHT = 600;
  static const GxEPD2::Panel panel = GxEPD2::GDEP073E01;  // FIXME: find proper panel enum
  ...
  // constructor
  GxEPD2_400c_GDEP040E01(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
  // methods (virtual)
  ...
  void drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h,
                  bool invert = false, bool mirror_y = false, bool pgm = false);
  void writeDemoBitmap(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h,
                       int16_t mode = 0, bool mirror_y = false, bool pgm = false);
  void drawDemoBitmap(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h,
                      int16_t mode = 0, bool mirror_y = false, bool pgm = false);
